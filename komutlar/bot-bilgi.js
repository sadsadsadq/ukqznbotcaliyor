...
module.exports.run = async (bot, message) => {
  try {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`Destek Sunucusu`, `[Tıkla!](https://discord.gg/NVqbnWs)`, true)
      .addField(
        `Botu Ekleyin`,
        `[Tıkla!](https://discordapp.com/oauth2/authorize?client_id=688298941049339913&scope=bot&permissions=8)`,
        true
      )
